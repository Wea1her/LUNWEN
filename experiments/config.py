...
# ========== 实验协议 ==========
EXPERIMENT_PROTOCOL_VERSION = "v5"
EXPERIMENT_PROTOCOL_NAME = "v5_train_val_test_seed_level"
TRAIN_POOL_SEED_OFFSET = 0
TEST_POOL_SEED_OFFSET = 20000
V5_SAVE_FULL_TRAIN_POOLS_MAX_EPISODES = 300
...
TERMINAL_RISK_EXPOSURE_WEIGHT = 0.70
TERMINAL_TOP10_RISK_WEIGHT = 0.50
...
VALIDATION_RISK_CEIL = 0.20
VALIDATION_OLDEST_COVERAGE_FLOOR = 0.90
VALIDATION_TOP10_RISK_CEIL = 0.15  # diagnostic only
VALIDATION_EDGE10_RISK_CEIL = 0.15  # main risk metric for head/tail sensitive regions
...
FORMAL_EVAL_CHECKPOINT_RULE = "best_delayed_smoothed_stability_validation_score"
VALIDATION_SMOOTHING_WINDOW = 3
VALIDATION_VARIANCE_PENALTY = 0.20
BEST_SELECTION_MIN_EPISODES = 300
BEST_FREEZE_ENABLED = True
BEST_FREEZE_PATIENCE = 8
BEST_FREEZE_MIN_EPISODES = 300
...
SELECTION_POLICY_VERSION = "v20260702_delayed_smoothed_stability_checkpoint"
...
STRICT_CONSTRAINTS = {
    ...
    "risk_ceil": 0.20,
    "top10_risk_ceil": 0.15,
    "edge10_risk_ceil": 0.15,
}
...
CURRICULUM_STAGE3_GAMMA_R_MULT = 1.35
CURRICULUM_STAGE3_TERMINAL_RISK_MULT = 1.30
CURRICULUM_STAGE3_TERMINAL_TOP10_MULT = 1.30
CURRICULUM_STAGE3_FAIRNESS_GATE_MIN = 0.55
EVIDENCE_FORMAL_MIN_SEEDS = 5
ENABLE_STRONG_BASELINE_DEFAULT = True
...
DYNAMIC_TRI_LAMBDA_F = 1.0
DYNAMIC_TRI_LAMBDA_W = 0.5
DYNAMIC_TRI_LAMBDA_R = 0.5
BASELINE_TUNING_ENABLED = True
BASELINE_TUNING_LAMBDA_F_GRID = [1.0]
BASELINE_TUNING_LAMBDA_W_GRID = [0.3, 0.5, 0.8]
BASELINE_TUNING_LAMBDA_R_GRID = [0.3, 0.5, 0.8]
BASELINE_TUNING_LATE_PROMO_GRID = [0.0, 0.2, 0.4]
